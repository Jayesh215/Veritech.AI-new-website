...
import { LogOut, BarChart3, Inbox, Mail, RefreshCw } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  return (
    <div data-testid="admin-dashboard" className="min-h-screen bg-[#050505] text-[#F4F4F5]">
      {/* Topbar */}
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-10 py-10">
        ...
        {tab === "analytics" && <AnalyticsTab summary={summary} refreshKey={refreshKey} />}
